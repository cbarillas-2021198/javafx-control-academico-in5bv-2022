...
public class CursosController implements Initializable {
    ...
    @FXML
    private TableColumn<Cursos,String> colCarrera;
    ...
    private void limpiarCampos() {
        ...
        cmbCarrera.valueProperty().set(null);
    ...
    public ObservableList getSalones() {
        ...
        ArrayList<Salones> arraListSalones = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                arraListSalones.add(salon);
            }

            listaObservableSalones = FXCollections.observableArrayList(arraListSalones);

        } catch (SQLException e) {
            System.err.println("Se produjo un error al intentar listar la tabla salones");
            System.err.println("Message: " + e.getMessage());
            System.err.println("Error code: " + e.getErrorCode());
            System.err.println("SQLState: " + e.getSQLState());
    ...
    public void cargarDatos(){
       ...
       colCarrera.setCellValueFactory(new PropertyValueFactory<>("carreraTecnicaId"));
       ...
       cmbCarrera.setItems(getCarrerasTecnicas());
    ...
    public void seleccionarElemento() {
        if (existeElementoSeleccionado()){
            ...
            cmbCarrera.getSelectionModel().select(
